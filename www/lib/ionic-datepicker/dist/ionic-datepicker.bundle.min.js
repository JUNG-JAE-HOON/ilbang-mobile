...
$.each(array, function(index, element) {     // 배열의 원소수만큼 반복
  if ($.inArray(element, result) == -1) {  // result 에서 값을 찾는다.  //값이 없을경우(-1)
    ...
    result.splice(result.indexOf(element),1);    //dog,cat,seal,lion,cat
  }
 });
return result;
}
function removeSelectDate(){
  console.log("달력초기화");
  selectDate=[];
}
...
function(e) {
    ...
    this.configDatePicker = function(n) {
        ...
        function r(e) {
            u.mainObj = angular.copy(e), u.selctedDateEpoch = i(u.mainObj.inputDate).getTime(), u.mainObj.weeksList && 7 === u.mainObj.weeksList.length ? u.weeksList = u.mainObj.weeksList : u.weeksList = ["일", "월", "화", "수", "목", "금", "토"], u.mainObj.mondayFirst && u.weeksList.push(u.mainObj.weeksList.shift()), u.disableWeekdays = u.mainObj.disableWeekdays, d(u.mainObj.inputDate), c(u.mainObj)
        }
        ...
        return u.today = i(new Date).getTime(), u.disabledDates = [], u.data = {}, u.prevMonth = function() {
          ...
          //  u.selctedDateEpoch = e.epoch;
          // u.checkDateEpoch1=e.epoch;

          // //  alert(u.mainObj.closeOnSelect);


            selectDate.push(e.epoch);
            selectDate = unique(selectDate);
            ...
            u.checkDateEpoch1=selectDate[0];
            u.checkDateEpoch2=selectDate[1];
            u.checkDateEpoch3=selectDate[2];
            u.checkDateEpoch4=selectDate[3];
            u.checkDateEpoch5=selectDate[4];
            }else{
              selectDate.pop();
              alert("5일까지 선택가능합니다.");
...
//checkDateEpoch
            // alert(u.selctedDateEpoch=e.epoch.closeOnSelect);
    ...
    this.monthsList = ["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"], this.getYearsList = function(e, n) {
        var t = [],
            a = 1900,
            o = 2100;
