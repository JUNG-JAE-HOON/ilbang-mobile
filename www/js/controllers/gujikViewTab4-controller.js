angular.module('gujikViewTab4-controller', [])
.controller('gujikViewTab4Ctrl', function($scope, $ionicPopup, $location, $http, $httpParamSerializerJQLike, $state,$stateParams) {
  // 팝업
