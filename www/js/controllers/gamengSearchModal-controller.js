angular.module('gamengSearchModal-controller', [])
.controller('gamengSearchModalCtrl', function($state, $localstorage, $scope, $ionicModal, $http, $httpParamSerializerJQLike) {
  $scope.lat = 0;
  $scope.lng = 0;
