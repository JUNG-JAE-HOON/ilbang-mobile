angular.module('viewResumeReview-controller', [])

.controller('viewResumeReviewCtrl', function($scope,$ionicPopup,$stateParams,$http,$httpParamSerializerJQLike,$localstorage) {
  //alert('t');
  //alert($stateParams.resume_no);
...
$scope.items = [];
  $scope.loadMore = function() {
    ...
    $scope.allPost = 0;
    var myData = {
      'resume_no':  $stateParams.resume_no
    }
